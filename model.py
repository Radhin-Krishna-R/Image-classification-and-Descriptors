...
class ImageCaptioningModel(tf.keras.Model):
    ...
    def build(self, input_shape):
        # Explicitly build all subcomponents
        self.cnn_model.build(input_shape[0])
        self.encoder.build((None, None, EMBEDDING_DIM))
        self.decoder.build((None, MAX_LENGTH))
        self.built = True
    ...
    def call(self, inputs, training=False):
        ...
        predictions = self.decoder(captions, encoder_output, training=training)
        return predictions
